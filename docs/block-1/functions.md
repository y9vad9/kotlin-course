...
Мені не до вподоби торкатися математики при поясненні деяких тем, але давайте все ж таки, спробуємо створити функцію засобами мови програмування.
За рівняння візьмемо наступний нескладний у розумінні вираз:
